package com.yahorshymanchyk.mylamp.ble
...
fun BleScreen(
    ...
    Column(
        ...
        Text("BLE (напрямую к Малине)", style = MaterialTheme.typography.headlineSmall)
        Text(
            "Заглушка — состояние только локальное, GATT-сервис на Pi ещё не поднят.",
